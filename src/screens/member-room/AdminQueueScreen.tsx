...
export default function AdminQueueScreen({ navigation }: { navigation: any }) {
  const [items, setItems] = useState([
    {
      ...
      avatarBg: '#0d2019',
      avatarColor: '#5DCAA5',
      subtitle: 'Reward nomination',
      amount: '+25 XRDM',
      badgeBg: '#0d2019',
      badgeBorder: '#1D9E75',
      badgeColor: '#5DCAA5',
      quote: 'Helped organise the annual reunion end-to-end with zero budget overrun.',
      meta: 'Nominated by: Yash Diwan · Jun 24',
    },
    {
      id: 2,
      type: 'claim',
      ...
      avatarBg: '#1e1428',
      avatarColor: '#AFA9EC',
      subtitle: 'Claim · endorsed by Arjun M',
      amount: '+30 XRDM',
      badgeBg: '#1e1428',
      badgeBorder: '#534AB7',
      badgeColor: '#AFA9EC',
      quote: 'Mentored three junior members through first open-source contribution…',
      endorsement: 'Vivek was patient and thorough. Genuinely helped us ship.',
      meta: 'Beneficiary endorsed: Jun 24',
    }
  ]);
  ...
  const handleAction = (id: number, action: string) => {
    ...
    navigation.navigate('HomeTab', { screen: 'History' });
  };
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.sc}>
        <View style={styles.scHdr}>
          <View>
            <Text style={styles.scEy}>Admin / committee</Text>
        ...
        {items.length === 0 ? (
          <Text style={styles.emptyText}>No pending items in queue.</Text>
        ) : (
          items.map(item => (
            <View 
              key={item.id} 
              style={[
                styles.itemCard, 
                item.type === 'claim' ? styles.itemCardClaim : styles.itemCardReward
              ]}
            >
              {/* Card Header */}
