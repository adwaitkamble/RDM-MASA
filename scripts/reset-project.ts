 ...
 * It deletes or moves the /src and /scripts directories to /example based on user input
 * and creates a new /src/app directory with an index.tsx and _layout.tsx file.
 */
...
const oldDirs: string[] = ["src", "scripts"];
